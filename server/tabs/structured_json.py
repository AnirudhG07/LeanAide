...
st.info("To use this structured proof to the `Server Response` page, there exists a button in that page when inputting `json_structured` in Inputs which will automatically add it there. You can also copy the JSON output and paste it manually.")
st.divider()
